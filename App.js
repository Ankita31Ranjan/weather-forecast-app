            ...
            <div className='leftContainer'>
              ...
              <div className='parameterContainerOne'>
                <div className='speedWrapper'>
                  <div className='speedIcon'><img src="https://img.icons8.com/ultraviolet/40/000000/wind--v1.png"alt="" /></div>
                  <div className='speedText' id='speed'>{todaysData.wind_speed} km/h</div>
                </div>
                <div className='humidityWrapper'>
                  <div className='humidityIcon'><img src="https://img.icons8.com/ultraviolet/40/000000/hygrometer.png" alt=""/></div>
